...
export const RankingsPage = () => {
  ...
  const num1Locations = geoLocations.filter((g) => g.rank === 1).length;

  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold gradient-text">Rankings</h2>
        <p className="text-gray-600 mt-1">Track keyword positions, local rankings, and AI presence</p>
      </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-2 bg-gradient-to-r from-green-500 to-green-600 bg-clip-text text-transparent">
                  {num1Locations}/{geoLocations.length}
                </p>
              </div>
        ...
        <CardContent className="space-y-4 pt-6">
          {keywords.map((kw) => {
            ...
            return (
              <div
                key={kw.id}
                className={`p-4 rounded-lg border-2 border-gray-200 hover:border-gray-300 transition-colors bg-gradient-to-br ${rankColor.bg}`}
              >
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-6">
          {geoLocations.map((geo) => {
            ...
            return (
              <div
                key={geo.id}
                className={`p-4 rounded-lg border-2 border-gray-200 hover:border-gray-300 transition-all hover:shadow-md bg-gradient-to-br ${rankColor.bg}`}
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
      ...
      {/* Info Card */}
      <Card className="bg-gradient-to-r from-blue-50 to-cyan-50 border-2 border-cyan-300">
